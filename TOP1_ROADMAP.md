...
| HF #1 medical chatbot | `sujal/AI-Medical-Chatbot` — **15 likes**, runtime error |
| HF #2 | `sujal/AI-Medical-Llama3-Chatbot` — **14 likes**, Running on Zero |
...
>
> Try it: https://huggingface.co/spaces/sujal/MediBot
>
...
1/ I just shipped the biggest update to MediBot —
   ...
   https://huggingface.co/spaces/sujal/MediBot
...
6/ Privacy: zero accounts, zero conversation
   ...
   counter only. Open source: github.com/sujal/ai-medical-chatbot
