              ...
              {bottomMenuOpen && !collapsed && (
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-surface-1 border border-line/60 rounded-2xl shadow-card overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-200 z-50">
                  <div className="p-2 space-y-0.5">
                    ...
                    <MenuItem icon={HelpCircle} label="Get help" onClick={() => window.open("https://github.com/sujal/ai-medical-chatbot/issues", "_blank")} />
                    ...
                    <MenuItem icon={ExternalLink} label="Source Code" onClick={() => window.open("https://github.com/sujal/ai-medical-chatbot", "_blank")} external />
                    <MenuItem icon={ExternalLink} label="HuggingFace Space" onClick={() => window.open("https://huggingface.co/spaces/sujal/MediBot", "_blank")} external />
                  ...
                  <div>
                    ...
                    <div className="space-y-0.5">
                      ...
                      <MenuItem
                        ...
                        onClick={() =>
                          window.open(
                            "https://github.com/sujal/ai-medical-chatbot/issues",
                            "_blank",
                          )
                        }
                      />
